...
object Retry {
  ...
  /** EXERCISE
    ...
    * and the `everySecond` schedule, create a schedule that repeats fives
    * times, evey second.
    */
  ...
  /** EXERCISE
    *
    * Using `Schedule#collect`, produce a schedule that recurs forever,
    * collecting its inputs into a list.
    */
