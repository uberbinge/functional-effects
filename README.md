...
1. Download the repository as a [zip archive](https://github.com/kitlangton/functional-effects/archive/master.zip).
...
2. Clone the repository.
    ...
    ```bash
    git clone https://github.com/kitlangton/functional-effects
    ```
